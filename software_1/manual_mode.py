...
def manual_mode_run():
	...
	while True:
		...
		if markerZero is False:
			cv2.putText(frame, f"key 0 => Select an A4 paper and then press ENTER", (50, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 2)
		if markerOne is False:
			cv2.putText(frame, f"key 1 => Select an A4 paper and then press ENTER", (50, 80), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 2)
